...
편집 가능한 SVG 버전은 [docs/assets/portfolio-cms-principle.svg](docs/assets/portfolio-cms-principle.svg)에 함께 보관합니다.
...
- 최종 README 삽입본: PaperBanana 생성 PNG를 사용하고, 한글 라벨을 안정적으로 재편집할 수 있도록 SVG 버전을 함께 제공
