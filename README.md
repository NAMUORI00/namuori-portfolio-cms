...
SVG 원본은 [docs/assets/portfolio-cms-principle.svg](docs/assets/portfolio-cms-principle.svg)에서 확인할 수 있습니다.
...
- 최종 README 삽입본: 영어 라벨 PNG를 사용하고, 같은 구조의 SVG 원본을 함께 제공
